...
namespace Text_RPG
{
    internal class Program
    {
        ...
        static void State(Player player)
        {
            ...
            Console.WriteLine($"공격력 : {player.Attack} +({player.AttackPercent})");
            Console.WriteLine($"방어력 : {player.Shield} +({player.ShieldPercent})");
        ...
        static void OpenInventory()
        {
            ...
            /*for(int i = 0; i < Inventory.changeName.Count; i++)
            {
                Console.WriteLine(Inventory.changeName[i]);
            }*/
        }
